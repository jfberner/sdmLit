...
#'
#' This function simply converts the output from the sdm package to the Boyce Index \insertCite{hirzelEvaluatingAbilityHabitat2006}{sdmTools} using the function from the ecospat package.
#'
...
#'
#' @return A list, and by default PEplot is plotted to the device. List contains three items: F.ratio, cor and HS. For more information please refer to \insertCite{hirzelEvaluatingAbilityHabitat2006}{sdmTools} or to the ecospat.boyce() help (linked below).
#' @export
#'
...
#'
#' @references
#' \insertRef{hirzelEvaluatingAbilityHabitat2006}{sdmTools}
#'
