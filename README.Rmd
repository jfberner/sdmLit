...
```{r congruence, echo=FALSE, fig.align='center', fig.cap="Global-scale bioclimatic congruence map to analyse environmental mismatches between recently updated bioclimatic databases.", out.width="100%"}
