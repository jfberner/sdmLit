...
```{r eval=T, echo=FALSE, fig.cap="Global-scale bioclimatic congruence map to analyse environmental mismatches between recently updated bioclimatic databases WorldClim v.2, MERRAclim  [@c.vegaMERRAclimHighresolutionGlobal2017], CHELSA, and ocean databases MARSPEC and Bio-ORACLE v. 2.0"}
