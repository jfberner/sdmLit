...
![Global-scale bioclimatic congruence map to analyse environmental mismatches between recently updated bioclimatic databases <a href="www.worldclim.org/version2">WorldClim v.2</a> , MERRAclim  [@c.vegaMERRAclimHighresolutionGlobal2017], <a href="www.chelsa-climate.org">CHELSA</a>, and ocean databases <a href="www.marspec.org">MARSPEC</a> and <a href="www.bio-oracle.org">Bio-ORACLE v. 2.0</a>]("inst/figures/README-congruence.png")
